defmodule ObsidianClipperExtensionWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ObsidianClipperExtensionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ObsidianClipperExtensionWeb.Gettext, "errors", msg, opts)
    end
  end
